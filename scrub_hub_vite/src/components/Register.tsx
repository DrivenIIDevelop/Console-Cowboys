          ...
          <div className="-mt-8">
            ...
            <form className="grid grid-cols-1 gap-x-4 gap-y-4" onSubmit={handleRegister}>
              ...
              <div>
                ...
                <div className="bg-gray border rounded bg-[#F7F7F7]">
                  <label>
                    <input
                    ...
                    />
                    <span className="pl-3 text-gray-500">I'm not a robot </span>
                  </label>
                </div>
              </div>
              <div>
                <label>
                  ...
                  />
                  <span className="pl-3">I agree with </span><span className="text-[#00AEB5]">Terms and Conditions</span>
                </label>
              </div>
              <div className="pt-10 justify-center mx-auto">
                <button className="bg-[#63C7B2] hover:bg-[#63C7B2]/90 text-white w-full py-2 px-6 rounded-md mr-10 font-bold" type="submit">Register</button>
                <span className="text-gray-500">Already have an account? </span><a className="font-bold" href='/authenticate/login'>Sign in</a>
